...
def load_my_dummy(dev_path, test_path, seed=42, val_size=0.2):
    ...
    groups = pd.read_csv("/home/wp/Documents/GitHub/DataProcessing/BotanicalGardenTomato/Raw_TS_Classification/Raw_TS_Classification_groups_1722_samples.csv") #note hard coded1
